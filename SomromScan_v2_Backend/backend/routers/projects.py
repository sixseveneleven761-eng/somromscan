...
def project_to_dict(p: Project) -> dict:
    ...
    return {
        ...
        "project_start_date": p.project_start_date.isoformat() + "Z" if p.project_start_date else None,
        "crediting_period_years": p.crediting_period_years,
        "crediting_period_end": p.crediting_period_end.isoformat() + "Z" if p.crediting_period_end else None,
        "registration_date": p.registration_date.isoformat() + "Z" if p.registration_date else None,
        ...
        "last_monitoring_date": p.last_monitoring_date.isoformat() + "Z" if p.last_monitoring_date else None,
        "next_verification_due": p.next_verification_due.isoformat() + "Z" if p.next_verification_due else None,
